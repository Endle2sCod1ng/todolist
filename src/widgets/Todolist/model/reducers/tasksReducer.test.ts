...
import { changeTaskStatusAC, changeTaskTitleAC, createTaskAC, deleteTaskAC, tasksReducer } from './tasksReducer';
...
test('correct task should change its title', () => {
  ...
  const endState = tasksReducer(startState, changeTaskTitleAC({ todolistId: 'todolistId2', taskId: '2', title: newTitle }));
